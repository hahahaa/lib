...
/*
 * This class implements a graphical login window and 
 * once the user has login, generates a GUI that allows the user to
 * execute all the transactions provided by the system, and display the results 
 */ 
